...
from infrastructure.integrations.llm.extract_total import _extract_total_retry_sync
from infrastructure.integrations.llm.normalize_keywords import _normalize_keywords_sync
...
from features.analytics.service.catalog import register_upload_candidates
from infrastructure.integrations.cube import CubeClient
from infrastructure.integrations.llm.models import TotalResponse
...
async def process_single_row(
    ...
    try:
        ...
        try:
            ...
            from infrastructure.integrations.llm.extract_total import _extract_total_sync
