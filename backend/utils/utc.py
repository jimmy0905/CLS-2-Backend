...
def as_timezone(value: datetime | None, timezone_name: str | None = None) -> datetime | None:
...
def local_isoformat(value: datetime | None, timezone_name: str | None = None) -> str | None:
